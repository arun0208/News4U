...
export const getStaticProps = async ()=>{
    const data = await axios.get(`https://newsapi.org/v2/top-headlines?country=in&pageSize=100&category=business&apiKey=6aa3a664cb254c79835764892ea11faf`)
  return {
  props: {
  news: data.data
  }
      ...
      return (
        <>
          ...
          <div class="container mx-auto">
            <h1 class="text-center">Business News</h1>
